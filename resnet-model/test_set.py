...
class GraphTrendTestDataset(Dataset): 
    def __init__(self, **kwargs):
        # load in the data 
        self.photos_path = kwargs['photos_path']
        #self.labels_path = kwargs['labels_path']
        self.labels_path = os.path.expanduser('~/graph-trend-understanding/data/test/concensus_labels.txt')
        #self.labels_path = os.path.expanduser('~/graph-trend-understanding/data/labels_for_captioning.txt')
    ...
    def __getitem__(self, idx): 
        path = os.path.join(self.photos_path, self.images[idx])
